...
vector<Position> Majayong::blech(vector<vector<Pokemon*>> map)
{
    int damage = 20;
...
vector<Position> Majayong::clearSmog(vector<vector<Pokemon*>> map)
{
    int damage = 20;
...
vector<Position> Majayong::sludge(vector<vector<Pokemon*>> map)
{
    int damage = 20;
...
vector<Position> Majayong::sludgeBomb(vector<vector<Pokemon*>> map)
{
    int damage = 20;
